...
export const metadata: Metadata = {
  title: "நன்கொடை | விடுதலைச் சிறுத்தைகள் கட்சி",
};
      ...
      <section className="bg-[#0A1628] min-h-[90vh] flex items-center justify-center px-6 py-24">
        <div className="max-w-lg w-full text-center">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-body)" }}
          >
            நன்கொடை வழங்கும் வசதி விரைவில் கிடைக்கும். மேலும் தகவல்களுக்கு எங்களை தொடர்பு கொள்ளவும்.
          </p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 text-left space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-white/40 text-xs uppercase tracking-widest mb-1" style={{ fontFamily: "var(--font-body)" }}>சமூக ஊடகங்கள்</p>

...
export function LoginForm() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8">
      <h2 className="text-xl font-semibold text-gray-900 mb-6 tamil-text">உங்கள் கணக்கில் உள்நுழைக</h2>
      ...
      <button
        ...
        className="mt-4 w-full py-2.5 px-4 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition flex items-center justify-center gap-2"
      >
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        <span className="tamil-text">கணக்கு இல்லையா?{" "}

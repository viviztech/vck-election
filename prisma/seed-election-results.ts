...
// rank1 = NDA top opponent. rank2 = TVK candidate. Votes filled via admin panel on result day.
const VCK_RESULTS = [
  {
  ...
  for (const r of VCK_RESULTS) {
    await prisma.electionResult.upsert({
      ...
      create: {
        ...
        rank2CandidateName: r.rank2CandidateName || null,
        rank2Party:         r.rank2Party || null,
        isWon:   false,
        status:  "COUNTING",
      },
      update: {

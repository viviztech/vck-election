...
// All 234 Tamil Nadu Assembly Constituencies — official order per EC PS LIST (PSLIST_19122025)
// Districts ordered by official district number 1–38, ACs ordered by AC number within each district
const ALL_CONSTITUENCIES: Array<{
  ...
  { districtCode: "TVL", code: "AC006", nameEnglish: "Avadi", nameTamil: "ஆவடி" },
  { districtCode: "TVL", code: "AC007", nameEnglish: "Maduravoyal", nameTamil: "மதுரவாயல்" },
  ...
  { districtCode: "TVL", code: "AC010", nameEnglish: "Thiruvottiyur", nameTamil: "திருவொற்றியூர்" },
  // Dist 2 — Chennai (16)
  ...
  { districtCode: "CHN", code: "AC014", nameEnglish: "Villivakkam", nameTamil: "வில்லிவாக்கம்" },
  ...
  // Dist 3 — Kancheepuram (4)
  { districtCode: "KAN", code: "AC028", nameEnglish: "Alandur", nameTamil: "ஆலந்தூர்" },
  { districtCode: "KAN", code: "AC029", nameEnglish: "Sriperumbudur", nameTamil: "ஸ்ரீபெரும்புதூர்" },
  { districtCode: "KAN", code: "AC036", nameEnglish: "Uthiramerur", nameTamil: "உத்திரமேரூர்" },
  ...
  // Dist 5 — Krishnagiri (6)
  { districtCode: "KRI", code: "AC051", nameEnglish: "Uthangarai", nameTamil: "ஊத்தங்கரை" },
  { districtCode: "KRI", code: "AC052", nameEnglish: "Bargur", nameTamil: "பர்கூர்" },
  ...
  { districtCode: "TVN", code: "AC066", nameEnglish: "Polur", nameTamil: "போளூர்" },
  ...
  // Dist 9 — Salem (11)
  { districtCode: "SLM", code: "AC081", nameEnglish: "Gangavalli", nameTamil: "கெங்கவல்லி" },
  { districtCode: "SLM", code: "AC082", nameEnglish: "Attur", nameTamil: "ஆத்தூர்" },
  { districtCode: "SLM", code: "AC083", nameEnglish: "Yercaud", nameTamil: "ஏற்காடு" },
  ...
  { districtCode: "SLM", code: "AC086", nameEnglish: "Edappadi", nameTamil: "எடப்பாடி" },
  ...
  { districtCode: "NMK", code: "AC093", nameEnglish: "Senthamangalam", nameTamil: "சேந்தமங்கலம்" },
  ...
  // Dist 12 — The Nilgiris (3)
  { districtCode: "NLR", code: "AC108", nameEnglish: "Udhagamandalam", nameTamil: "உதகமண்டலம்" },
  { districtCode: "NLR", code: "AC109", nameEnglish: "Gudalur", nameTamil: "கூடலூர்" },
  { districtCode: "NLR", code: "AC110", nameEnglish: "Coonoor", nameTamil: "குன்னூர்" },
  // Dist 13 — Coimbatore (10)
  { districtCode: "CBE", code: "AC111", nameEnglish: "Mettupalayam", nameTamil: "மேட்டுப்பாளையம்" },
  ...
  { districtCode: "CBE", code: "AC121", nameEnglish: "Singanallur", nameTamil: "சிங்காநல்லூர்" },
  ...
  // Dist 16 — Tiruchirappalli (9)
  { districtCode: "TIR", code: "AC138", nameEnglish: "Manapparai", nameTamil: "மணப்பாறை" },
  ...
  { districtCode: "TIR", code: "AC144", nameEnglish: "Manachanallur", nameTamil: "மண்ணச்சநல்லூர்" },
  ...
  // Dist 18 — Cuddalore (9)
  { districtCode: "CUD", code: "AC151", nameEnglish: "Tittakudi", nameTamil: "திட்டக்குடி" },
  ...
  // Dist 22 — Pudukkottai (6)
  { districtCode: "PUD", code: "AC178", nameEnglish: "Gandharvakottai", nameTamil: "கந்தர்வகோட்டை" },
  ...
  { districtCode: "TPN", code: "AC217", nameEnglish: "Ottapidaram", nameTamil: "ஒட்டப்பிடாரம்" },
  { districtCode: "TPN", code: "AC218", nameEnglish: "Kovilpatti", nameTamil: "கோவில்பட்டி" },
  // Dist 29 — Tirunelveli (5)
  ...
  { districtCode: "KKN", code: "AC231", nameEnglish: "Colachel", nameTamil: "கொலாச்சல்" },
  { districtCode: "KKN", code: "AC232", nameEnglish: "Padmanabhapuram", nameTamil: "பத்மனாபபுரம்" },
  ...
  // Dist 32 — Tirupur (8)
  { districtCode: "TRV", code: "AC101", nameEnglish: "Dharapuram", nameTamil: "தாராபுரம்" },
  ...
  // Dist 35 — Chengalpattu (7)
  { districtCode: "CGT", code: "AC027", nameEnglish: "Sholinganallur", nameTamil: "சோழிங்கநல்லூர்" },
  ...
  // Dist 37 — Ranipet (4)
  { districtCode: "RAN", code: "AC038", nameEnglish: "Arakkonam", nameTamil: "அரக்கோணம்" },
